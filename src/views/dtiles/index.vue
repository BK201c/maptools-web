<template>
  <section>
    <div class="form">
      <a-button type="primary" @click="add3dtiles()">custom</a-button>
      <a-button type="primary" @click="addExample()">OSM</a-button>
      <a-button type="primary" @click="clearAllModel()">clear</a-button>
    </div>
